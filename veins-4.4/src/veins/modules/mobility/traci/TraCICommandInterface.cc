...
/* Addition for pveins! */
void TraCICommandInterface::Vehicle::changeLane(int8_t lane_idx, int32_t duration)
{
    uint8_t variableId = CMD_CHANGELANE;
    uint8_t variableType = TYPE_COMPOUND;
    int32_t count = 2;

    uint8_t variableTypeLane = TYPE_BYTE;
    uint8_t variableTypeDuration = TYPE_INTEGER;
